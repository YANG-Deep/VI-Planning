...
private:
    ...
    void hexStringCallback(const std_msgs::msg::String::SharedPtr msg) {
        ...
        // RCLCPP_INFO(this->get_logger(), "Decoded String: %s", decodedString.c_str());

        // int length = decodedString.length();
        // RCLCPP_INFO(this->get_logger(), "String Length: %d", length);

        // if ((length - 1) % 4 == 0) {
        //     RCLCPP_INFO(this->get_logger(), "The length of the string minus 1 is divisible by 4.");
        // } else {
        //     RCLCPP_INFO(this->get_logger(), "The length of the string minus 1 is not divisible by 4.");
        // }
